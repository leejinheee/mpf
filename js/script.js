...
$(document).ready(function(){
    ...
    //#1. 배열 데이터를 구성한다.
    var $popup = [
        ["Portfolio", "jh_1_5.png", "2022년 2월 ~", "<li>responsive Web</li>", "-", "<li>design 100%</li> <li>publishing 100%</li> <li>script 100%</li>", "<li>XD</li> <li>Photoshop</li> <li>Visual Studio Code</li>", "저의 작품을 보여주는 개인 포트폴리오 웹사이트입니다.<br><br>카테고리의 한계 없이 다양한 창작물을 만들어 소개하는 공간으로 제작하였습니다.<br>직접 기획부터 디자인, 코딩까지 작업하였으며 가능한 간결하고, 명확한 웹사이트를 구축하는 것이 목표였습니다.<br>작품을 돋보이게 전시하며 내용의 중요성을 고려한 콘텐츠 배치와 레이아웃으로 설계했습니다.<br><br>전반적인 컬러는 특성상 작품 소개가 위주이기 때문에 스트롱 컬러보다<br>노멀하지만 각인효과의 요소가 있는 컬러인 Black & white를 함께 사용하여 깔끔히고 유니크한 이미지를 전달하였습니다.<br>포인트 컬러로는 Pink를 사용하여 강조의 기능을 효과적으로 표현하였습니다.<br><br>새로운 작품에 대한 정보를 지속적으로 업데이트하여 관리합니다.", `<a href="http://jinhee.kr/nails">See the website</a>`, `<img class="mBot0" src="./img/jh_2.png"> <img class="mBot0" src="./img/jh_3.png"> <img class="mBot0" src="./img/jh_4.gif"> <img class="mBot0" src="./img/jh_5.png"> <img class="mBot0" src="./img/jh_6.gif">`],
